...
<Image
  src={squirrelImage}
  alt="A typical squirrel trying to eat my precious flowers"
  layout="responsive"
  class="lg:max-w-1/2"
/>
<div class="mx-auto text-center lg:max-w-1/2" style="margin-top:-1rem">
  <p>
    <i>
      A typical squirrel trying to eat my precious flowers, courtesy of{" "}
      <a href="https://unsplash.com/@sagredophotography">Richard Sagredo</a>
    </i>
  </p>
</div>

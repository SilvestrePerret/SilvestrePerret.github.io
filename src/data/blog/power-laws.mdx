...
About uncertainty? About rare events?
...
On the other hand, the second game is nerve-wracking! Sometimes you break the bank with a huge win, even if your median winnings are just $1.
...
In this simulation, trees grow and occasionally catch fire. Most fires are small, but occasionally, a lightning strike can cause a massive fire that burns a significant portion of the forest. Play with it [here](https://www.veritasium.com/simulation5). It's more fun than what it looks like.
...
This idea is very much developped by Per Bak, Chao Tang and Kurt Wiesenfield in [their 1987 paper](https://psychsafety.com/wp-content/uploads/2025/04/SOC.pdf)
...
- **Business opportunities accumulate over time but they are hard to identify. Even major actors miss them despite their deep understanding and vast resources (e.g. Nokia with the digital camera or more recently Google with the Transformer).**

![It's all connected meme](../../assets/images/its-all-connected-meme.png)

## What's the point?

Real life™ is more complex than what we are comfortable with. The same way learning about history is a terrible way to predict the future, using this newly acquired knowledge to guide every choices you make is not it.
...
2. As nobody has inifinite resources to keep playing (time, money, energy), any edge available to improve your odds is worth much more than what you think (try my mini-games again to see it in action). Use all your wisdom, experiences so that the coin you flip is at least fair if not in your favor.
